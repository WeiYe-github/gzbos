            ...
            $("#btnEp").click(function () {
                ...
                if (v) {
                    ...
                    if (newPwd == rePwd) {
                        ...
                        //2.参数
                        var prmts = {password: newPwd};
                        //3.回调
                        //4.处理返回的结果类型
                        $.post(url, prmts, function (data) {
                            //后台返回{"success":"1"} 数据
                            if (data.success == 1) {
    ...
    <div class="easyui-layout" fit="true">
        <div region="center" border="false" style="padding: 10px; background: #fff; border: 1px solid #ccc;">
            <form method="post" id="editPasswordForm"
                  action="${pageContext.request.contextPath}/userAction_editPassword.action">
                <table cellpadding=3>
                    <tr>
                        <td>新密码：</td>
                        <td><input id="txtNewPass" type="Password" class="txt01 easyui-validatebox"
                                   name="password" required="true" data-options="validType:'length[4,8]'"
                        /></td>
                    </tr>
                    <tr>
                        <td>确认密码：</td>
