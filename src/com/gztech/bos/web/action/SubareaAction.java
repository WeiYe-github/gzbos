...
import com.gztech.bos.service.ISubareaService;
import com.gztech.bos.utils.PinYin4jUtils;
...
public class SubareaAction extends BaseAction<Subarea> {
    ...
    public void test1() {
        //通过id查找定区
        Subarea subarea = subareaService.find("BB001");
        System.out.println("分区的关键字:" + subarea.getAddresskey());//hibernate的session已经没了
